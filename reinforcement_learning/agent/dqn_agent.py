...
class DQNAgent:
    ...
    def __init__(self, Q, Q_target, num_actions, gamma=0.95, batch_size=64, epsilon=0.1, tau=0.01, lr=1e-4, history_length=1e5):
        """
    ...
    def train(self, state, action, next_state, reward, terminal):
        ...
        self.replay_buffer.push(state, action, next_state, reward, terminal)
    ...
    def act(self, state, deterministic):
        ...
        if deterministic or r > self.epsilon:
            ...
            # found, so we pick action with the larger expected reward.
                action_id = self.Q(state).max(1)[1].view(1, 1)

            # TODO: take greedy action (argmax)
            # action_id = ...
        else:
            action_id = torch.tensor([[np.random.randrange(self.num_actions)]], device=device, dtype=torch.long)
